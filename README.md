WebAuthn Library
=============
[![GoDoc](https://godoc.org/webauthn?status.svg)](https://godoc.org/webauthn)
![Build Status](https://webauthn/workflows/Go/badge.svg)
[![Go Report Card](https://goreportcard.com/badge/webauthn)](https://goreportcard.com/report/webauthn)
...
### Demo at webauthn.io
An implementation of this library can be used at [webauthn.io](https://webauthn.io) and the code for this website can be found in the Duo Labs repository [`webauthn-io`](https://webauthn.io).
...
Quickstart
----------
`go get webauthn` and initialize it in your application with basic configuration values. 
